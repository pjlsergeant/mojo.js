...
export default class File {
  ...
  /**
   * Create a child File based on provided path parts
   * @param  {...string} parts
   * @returns {File}
   */
  child (...parts) {
  ...
  /**
   * Return a new path representing the dirname of the specified file
  ...
  /**
   * Return a Promise<Boolean> indicating if the path exists or not
   * @see https://nodejs.org/api/path.html#path_path_dirname_path
   */
...
export {callerFile, currentFile, tempDir, File};
